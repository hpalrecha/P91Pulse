...
export default function VehicleSearch() {
  ...
  // Fetch vehicles for the detailer
  const {
    data: vehicles,
  ...
  const handleCustomerClick = (customerId: number) => {
    navigate(`/erp/detailer/customers/${customerId}`);
  };
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center justify-between gap-2">
            ...
            <InfoDot widgetId="detailer.vehicleSearch.filters" fallbackLabel="Search Filters" />
          </CardTitle>
          <CardDescription>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center justify-between gap-2">
            ...
            <InfoDot widgetId="detailer.vehicleSearch.table" fallbackLabel="Search Results" />
          </CardTitle>
          <CardDescription>

...
export default function CustomerDetails() {
  ...
  const [match, params] = useRoute<{ id: string }>('/erp/distributor/customers/:id');
  ...
  const [assignedDetailer, setAssignedDetailer] = useState<any>(null);
  ...
  const fetchCustomerDetails = async (customerId: number) => {
    try {
      ...
      // Fetch assigned detailer if any
      if (customerData.detailerId) {
        const detailerResponse = await apiRequest("GET", `/api/erp/users/${customerData.detailerId}`);
        const detailerData = await detailerResponse.json();
        setAssignedDetailer(detailerData);
      }
      ...
      const claimsResponse = await apiRequest("GET", `/api/erp/customers/${customerId}/claims`);
    ...
    <div className="container py-6">
      ...
      {loading ? (
                    ...
                    {assignedDetailer && (
                      <div className="text-sm mt-2">
                        ...
                        <div className="flex items-center mt-1">
                          ...
                          <span className="font-medium">{assignedDetailer.name}</span>
                        </div>
                      </div>
                    )}
                  </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <ClipboardList className="h-5 w-5 mr-2 text-yellow-500" />
                      <span>Claims</span>
                    </div>
          ...
          <Tabs defaultValue="vehicles" className="w-full">
            ...
            <TabsContent value="vehicles" className="mt-0">
              <CustomerVehicles 
                ...
                // Only allow adding vehicles if it's an end customer, not for leads
                showAddButton={customer.leadStage === 'customer'}
              />
            </TabsContent>
              ...
              <Card>
                ...
                <CardContent>
                  {claims.length === 0 ? (
                    ...
                    <div className="rounded-md border">
                      {/* Claims table content here */}
                      <p className="p-4">Claims data would be displayed here.</p>
                    </div>
                  )}
                </CardContent>
              </Card>
        ...
        <div className="text-center py-12">
          ...
          <Button onClick={() => setLocation('/erp/distributor/leads')}>
            Back to Customers
          </Button>
        </div>
      )}

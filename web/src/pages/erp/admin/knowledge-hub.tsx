...
import { Search, Filter, BookOpen, FileText, Video, Download, Eye, Plus, Calendar, User, Tag } from 'lucide-react';
...
const KnowledgeHubPage: React.FC = () => {
  ...
  const [newContent, setNewContent] = useState({
    ...
    category: 'installation' as KnowledgeItem['category'],
    tags: '',
    fileSize: '',
    duration: ''
  });
  ...
  const dummyKnowledge: KnowledgeItem[] = [
    ...
    {
      id: 4,
      title: 'P91 Product Catalog 2025',
      description: 'Complete product catalog featuring all P91 PPF products, specifications, and pricing information',
      type: 'document',
      ...
      downloadCount: 567,
      fileSize: '5.2 MB',
      tags: ['catalog', 'products', '2025', 'specifications'],
      status: 'published',
      fileUrl: '/docs/p91-catalog-2025.pdf'
    },
    {
      id: 5,
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-gray-600 flex items-center justify-between gap-2">
              ...
              <InfoDot widgetId="admin.knowledge.totalItems" fallbackLabel="Total Items" />
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-blue-600 flex items-center justify-between gap-2">
              ...
              <InfoDot widgetId="admin.knowledge.published" fallbackLabel="Published" />
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-green-600 flex items-center justify-between gap-2">
              ...
              <InfoDot widgetId="admin.knowledge.totalDownloads" fallbackLabel="Total Downloads" />
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-red-600 flex items-center justify-between gap-2">
              ...
              <InfoDot widgetId="admin.knowledge.videos" fallbackLabel="Videos" />
            </CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg flex items-center justify-between gap-2">
            ...
            <InfoDot widgetId="admin.knowledge.filters" fallbackLabel="Search & Filters" />
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center justify-between gap-2">
            ...
            <InfoDot widgetId="admin.knowledge.table" fallbackLabel="Knowledge Base" />
          </CardTitle>
          <CardDescription>
      ...
      <Dialog open={showAddContent} onOpenChange={setShowAddContent}>
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Add new knowledge base content for the team
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select 
                  ...
                  onValueChange={(value: KnowledgeItem['type']) => 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select 
                  ...
                  onValueChange={(value: KnowledgeItem['category']) => 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {(newContent.type === 'document' || newContent.type === 'manual' || newContent.type === 'guide') && (
                <div className="space-y-2">
                  <Label htmlFor="fileSize">File Size</Label>
                  <Input
                    id="fileSize"
                    placeholder="e.g., 2.5 MB"
                    value={newContent.fileSize}
                    onChange={(e) => setNewContent({...newContent, fileSize: e.target.value})}
                  />
                </div>
              )}
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                <div className="space-y-2">
                  ...
                  <div className="text-sm text-gray-600">
                    ...
                    <p className="text-xs text-gray-500">PDF, DOC, MP4, or other files</p>
                  </div>
